...
объекта, open/click email-трекинг, авто-рефреш сегментов, нижняя строка футера (языки/валюты),
`syncReports`/Meta CAPI (нужны внешние ключи), серверный PDF-инвойс.
...
- 🟡 Вынести «обвязку» в редактируемые поля: ✅ монограмма (`3ed639c`), ✅ «Licensed Realtor» (`966851a`), ✅ районы Дубая в футере (`dbb482d`); осталось нижняя строка футера (языки/валюты). [5]
