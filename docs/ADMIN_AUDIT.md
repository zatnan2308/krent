...
- ✅ P1-10 (часть) подсветка overdue-задач (`822fe99`)
- ✅ P1-11 (часть) поиск в объектах + контактах (`0ef6f44`, `ac8b3c7`)
...
- ⬜ P1-10 (хвост) напоминания о задачах (cron→bell/email) + назначение задачи другому агенту
- ⬜ P1-11 (хвост) поиск/фильтр в списке leads + пагинация длинных списков
...
- Bookings: поиск/диапазон/пагинация, колонка источника; серверный PDF-инвойс. [1]
