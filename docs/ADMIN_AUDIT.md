...
- серверный PDF-инвойс — тяжёлая зависимость, вывод не проверить без запуска;
- P1-14 хвост: вложенные дропдауны навигации + выбор `page_id` — дизайн-чувствительный
  editorial-header, нужна визуальная проверка;
